...
//        String[] s3_path = args[cur_arg].split("/", 2);
        String bucket_name = "m-source-bucket";
        String key_name = "folder1/";
//        boolean s3_path_is_prefix = (key_name.lastIndexOf('/') == key_name.length() - 1);
        boolean s3_path_is_prefix = true ;
        cur_arg += 1;
        ...
        // name.
        String local_path = "./dwnlds/";
//        String local_path = "/home/ruyam/projects/wahidSirProjects/backend/sirLatest/temp/awss3multifiledownload/downloads/";
